...
const SavePost = ({userId, blogId, url, cover}) => {
    ...
    return ( 
        <div> 
           {saved === true ? <><img title="Remove" src={Saved} alt="saved" className="save-btn" onClick={handleRemoveSave} /></>:<><img title="Save" src={Save} alt="save" className="save-btn" onClick={handleSave}/></>}
        </div>
     );
}
