...
import {getDoc ,doc, where, query, collection, getDocs} from "firebase/firestore";
    ...
    return (
        ...
        <div className="switch-section">
            <div className="switch-box">
                <div className="switch-left" onClick={toggleSwitchLeft} style={{borderTop: activeSwitch === true ? "1.5px solid black" : "none", opacity: activeSwitch === true ? "1" : "0.5"}}><img src="https://cdn-icons-png.flaticon.com/512/238/238910.png" alt="" height="15px" width="15px" style={{marginRight:"5px"}} /> BLOGS</div>
                <div className="switch-right" onClick={toggleSwitchRight} style={{borderTop: activeSwitch === false ? "1.5px solid black" : "none", opacity: activeSwitch === false ? "1" : "0.5"}}><img src="https://cdn-icons-png.flaticon.com/512/5668/5668020.png" alt="" height="15px" width="15px" style={{marginRight:"5px"}} /> SAVED</div>
            </div>
        </div>
